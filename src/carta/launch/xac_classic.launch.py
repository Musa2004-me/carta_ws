...
def generate_launch_description():
    ...
    # ================== Load URDF/Xacro ==================
    model_file = os.path.join(get_package_share_directory(package_name), 'model', 'all.urdf.xacro')
    robot_description_config = xacro.process_file(model_file)
    robot_description = robot_description_config.toxml()

    # ================== Gazebo World ==================
    world_file = os.path.join(get_package_share_directory(package_name), 'worlds', 'new_world.world')
